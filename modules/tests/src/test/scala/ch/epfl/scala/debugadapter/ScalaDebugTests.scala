  ...
  test("should show the correct stackTrace insde a map") {
    ...
    check(
      Breakpoint(
        11,
        List(
          "Main$Hello.greet$$anonfun$1(int)",
          "Main$Hello.greet$$anonfun$adapted$1(Object)",
          "Main$Hello$$Lambda$3/0x0000000800c91800.apply(Object)",
          "List.map(Function1)",
          "Main$Hello.greet()",
          "Main$.main(String[])",
          "Main.main(String[])"
  ...
  test("should show the correct stackTrace insde a foreach") {
    ...
    check(
      Breakpoint(
        ...
        List(
          "Main$Hello.greet$$anonfun$1(int)",
          "Main$Hello$$Lambda$3/0x0000000800c919f8.apply$mcVI$sp(int)",
          "JFunction1$mcVI$sp.apply(Object)",
